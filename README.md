# Effortless API Windows Native App Seed Project

This project lets you create a dotnet Windows Native App project which can natively
...
Fork this repository - then clone the project locally
    ...
    > git clone git@github.com:you/eapi-airtable-winapp-seed project-xyz
    > cd project-xyz
...
Use the following instructions to tailor the example for your project.
    ...
    1. Open the `DotNet/WindowsFormsApp1/App.Config` and replace `your-project-url` with the url to your project.
    2. Replace the `admin.GetTABLEXYZ()` with one of your actual tables in `DotNet/WindowsFormsApp1/Program.cs`.  
